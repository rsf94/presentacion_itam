%% This Beamer template is based on the one found here: https://github.com/sanhacheong/stanford-beamer-presentation, and edited to be used for Stanford and ITAM by Rafael Sandoval
...
\title[Multiplicador de impuestos]{Multiplicador de impuestos en México}
\subtitle{Enfoque DSGE}

%\beamertemplatenavigationsymbolsempty

\begin{document}

\author[Multiplicador de impuestos]{
	\begin{tabular}{c} 
	\large
	Alfredo Lefranc , Rafael Sandoval
\end{tabular}
\vspace{-4ex}}
...
\institute{
	...
	\begin{figure}
		\centering
			\includegraphics[height=0.33in]{./style_files_stanford/logoITAM.png}
	\end{figure}
	\vskip 5pt
	...
	\begin{itemize}
        ...
        \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Objective \\ Function\end{tabular}} &
         ...
         &
          ...
          \begin{tabular}[c]{@{}c@{}}Human action model is well known, \\ but objectivsdaasdae is not (e.g. joy-riding in car \\ or free running, where destination\\  or direction is unclear)\end{tabular} &
